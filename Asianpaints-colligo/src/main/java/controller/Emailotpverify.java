...
/**
 * Servlet implementation class Emailotpverify
 */
@WebServlet("/Emailotpverify")
public class Emailotpverify extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(validatecheck.equals(true)) {
			Object LoginString = forgotcall.verifyEmailOtp(data);
